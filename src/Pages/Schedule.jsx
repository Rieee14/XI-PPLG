...
const Schedule = () => {
    ...
    piketGroup = [
        ["Aditya", "Gibran", "Jamila", "Riyadi", "Royyan", "Ari Febrian"],
        ["Aceng", "Aldi S", "Sakti", "Salsa", "Maulana", "Salfaraz"],
        ["Anas", "Nopa", "Rifai", "Eldiaz", "Afrida", "Salman"],
        ["Zacki", "Ilham", "Fahri", "Fadzri", "Fachru"],
        ["Rafi", "Neiza", "Dhira", "Aldi F", "Clarisa", "Angellia"],
    ]
